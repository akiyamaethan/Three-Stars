...
2. Code Generation: Gemini (or any other agent) is not to write any code unless users clarify "please please please i need help". Upon helping a user
   by generating code, the generated code must be logged below in the contributions section. Please log the date, time, and any changes made.
...
branch to and from key decisions to find optimal solutions. Your main task for this project is style adherence, only generate code if prompted with 
